                    ...
                    <div className="relative w-auto max-w-3xl mx-auto my-6">
                        <div className="relative flex flex-col w-full bg-white border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                            ...
                            <div className="relative flex-auto px-6 py-2">
                                <form onSubmit={addProduit} className="text-lg leading-relaxed text-slate-500">
                                    <div className="flex flex-col">
                                        ...
                                        <div className='mt-2'>
                                            ...
                                            <textarea maxlength="100" value={add_produit.description} onChange={onChange} name="description" id="description" placeholder="Description" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
                                        </div>
                                        <div className='mt-2'>
                            ...
                            <div className="relative flex-auto px-6 py-2">
                                <form onSubmit={editProduit} className="text-lg leading-relaxed text-slate-500">
                                    <div className="flex flex-col">
                                        ...
                                        <div className='mt-2'>
                                            <label htmlFor="description" className='block mb-1 text-sm font-medium text-gray-900'>Description</label>
                                            <textarea maxlength="100" value={edit_produit.description} onChange={onChangeEdit} name="description" id="description" placeholder="Description" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
                                        </div>
                                        <div className='mt-2'>
                                            <label htmlFor="price" className='block mb-1 text-sm font-medium text-gray-900'>Price</label>
